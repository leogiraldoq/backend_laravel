<html>
    ...
    <body>
        <div>
            ...
            <b>Receiving Receipt # {{ $sendToView['follow_number'] }}</b><br/>
            ...
            <p><b>Store:</b> {{ $sendToView['shop'] }}<br/>
            ...
            <table class="text-center mb-2 ml-1 ticketFont">
                ...
                @foreach ($sendToView['tableResume'] as $ticket)
                    <tr>
                        <td>{{$ticket['boutique']}}</td>
